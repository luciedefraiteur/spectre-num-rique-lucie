...
var Context = /** @class */ (function () {
    ...
    Context.prototype.eatSymbol = function () {
        ...
        switch (c) {
            case '{':
                tkn = types_js_1.TokenType.OBJ_OPEN;
                break;
            case '}':
                tkn = types_js_1.TokenType.OBJ_CLOSE;
                break;
            case '[':
                tkn = types_js_1.TokenType.ARR_OPEN;
                break;
            case ']':
                tkn = types_js_1.TokenType.ARR_CLOSE;
                break;
            case ':':
                tkn = types_js_1.TokenType.COLON;
                break;
        }
        if (c === ',') {
            this.index++;
    ...
    Context.prototype.eatMultilineString = function () {
        ...
        this.addToken(types_js_1.TokenType.STRING, start, str);
    ...
    Context.prototype.eatIdentifier = function () {
        ...
        if (this.RX_DECIMAL.test(str)) {
            this.addToken(types_js_1.TokenType.NUMBER, start, parseFloat(str));
        }
        else if (this.RX_HEXA.test(str)) {
            this.addToken(types_js_1.TokenType.NUMBER, start, parseInt(str, 16));
        }
            ...
            this.addToken(types_js_1.TokenType.NUMBER, start, parseInt(str, 8));
        }
            ...
            this.addToken(types_js_1.TokenType.NUMBER, start, parseInt(str, 2));
        }
        else {
            var type = types_js_1.TokenType.SPECIAL;
            var value = str;
            if (str === 'null')
                value = null;
                ...
                type = types_js_1.TokenType.STRING;
...
exports.Tokenizer = {
    OBJ_OPEN: types_js_1.TokenType.OBJ_OPEN,
    OBJ_CLOSE: types_js_1.TokenType.OBJ_CLOSE,
    ARR_OPEN: types_js_1.TokenType.ARR_OPEN,
    ARR_CLOSE: types_js_1.TokenType.ARR_CLOSE,
    STRING: types_js_1.TokenType.STRING,
    NUMBER: types_js_1.TokenType.NUMBER,
    SPECIAL: types_js_1.TokenType.SPECIAL,
    COLON: types_js_1.TokenType.COLON,
