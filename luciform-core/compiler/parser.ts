...
import {normalizeLineEndings, detectDialect, Dialect} from './prelude.js';
import {detectLucidExtensionsInLine, LucidExtensionKind, SymbolicInvocationExtension, DataPactExtension} from './lucid_extensions.js';
