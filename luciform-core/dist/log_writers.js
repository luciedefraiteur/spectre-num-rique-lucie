...
export async function logGolem(message, level = 'info') {
    const content = `
## GOLEM SERVER LOG
...
export async function logGolemClient(message, level = 'info') {
    const content = `
## GOLEM CLIENT LOG
- **Level:** ${level.toUpperCase()}
- **Message:** ${message}
...
export async function logPersonaAction(persona, command, ritual) {
    const content = `
...
export async function logRitual(message, logFileName = 'ritual.log') {
