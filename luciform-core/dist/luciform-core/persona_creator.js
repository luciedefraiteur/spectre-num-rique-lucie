...
export async function createPersona(personaName, context) {
    ...
    try {
        const llmResponse = await LLMInterface.query(lurkuitaePrompt, LLMModel.GeminiPro); // Cast to any to bypass type checking
