import { LuciformTokenizer, LuciformTokenType } from './tokenizer.js';
export function parseLuciformDocument(luciformContent) {
    ...
    const parseKardia = () => {
        ...
        try {
            return JSON.parse(kardiaContent);
        }
        catch (error) {
    ...
    const parseAction = (actionContent) => {
