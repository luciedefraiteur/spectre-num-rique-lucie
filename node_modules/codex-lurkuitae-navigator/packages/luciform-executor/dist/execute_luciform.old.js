...
const batch_editor_1 = require("./batch_editor"); // This will be moved to luciform-executor later
...
async function parseLuciform(filePath, args, variables) {
...
async function main() {
    ...
    const interactiveVariables = new Map();
    if (!luciformPath) {
...
`;
                    ...
                    await (0, batch_editor_1.applyOperation)(op, dryRun);
                }
            }
            catch (opError) {
...
main();
//# sourceMappingURL=execute_luciform.old.js.map