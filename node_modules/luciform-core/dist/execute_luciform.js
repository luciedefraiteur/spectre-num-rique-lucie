...
export async function executeLuciform(filePath, logFileName = 'ritual.log') {
            ...
            if (pas.action) {
                ...
                switch (pas.action.type) {
                    case 'json_action':
                        ...
                        break;
                    case 'help_request':
                        const helpRequestOp = pas.action;
                        ...
                        break;
                    default:
                        throw new Error(`Unknown operation type: ${pas.action.type}`);
                }
                if (operation) {
