...
export async function handleTraverse(incantation, context, existsSync = fs.existsSync, statSync = fs.statSync) {
    const result = { incantation, index: -1 };
...
export async function handleEnact(incantation, context, plan, ask, runCommand = handleSystemCommand) {
    const result = { incantation, index: -1, success: false };
    const cmd = incantation.invocation.trim();
    if (cmd.startsWith('traverse')) {
        const newIncantation = { type: 'traverse', invocation: cmd.replace('traverse', '').trim() };
        return handleTraverse(newIncantation, context);
    }
    const commandOutcome = await runCommand(cmd, context.current_sanctum, context);
...
export async function handleDivine(incantation, context, index, plan) {
    const result = { incantation, index };
...
export async function handleLull(incantation, context) {
    const result = { incantation, index: -1 };
...
export async function handleDiscourse(incantation) {
    const result = { incantation, index: -1 };
    result.text = incantation.invocation;
    return result;
}
export async function handleQuery(incantation, context, ask) {
    const result = { incantation, index: -1 };
...
export async function handleResponse(incantation) {
    const result = { incantation, index: -1 };
    result.text = incantation.invocation;
    return result;
}
export async function handlePreExecutionCheck(incantation, context) {
    const result = { incantation, index: -1 };
...
export async function handleUserConfirmation(incantation, ask) {
    const result = { incantation, index: -1 };
...
export async function handleCodeGeneration(incantation) {
    const result = { incantation, index: -1 };
...
export async function handleAssistedEditing(incantation, context, ask) {
    const result = { incantation, index: -1, success: true };
...
export async function handleUserInput(incantation, ask) {
    const result = { incantation, index: -1 };
    console.log(`
...
export async function handleStepProposal(incantation) {
    const result = { incantation, index: -1, success: true };
...
export async function handleDreamNavigation(incantation, context) {
    const result = { incantation, index: -1, success: true };
    const targetPath = incantation.invocation.split('/').filter((p) => p.length > 0);
...
export async function handleReflectionNavigation(incantation, context) {
    const result = { incantation, index: -1, success: true };
    const targetPath = incantation.invocation.split('/').filter((p) => p.length > 0);
...
export async function handleAddReflection(incantation) {
    const result = { incantation, index: -1, success: true };
...
export async function handleSurveil(incantation, context) {
    const result = { incantation, index: -1, success: true };
    const filePath = path.resolve(context.current_sanctum, incantation.invocation);
    try {
...
export async function handleTerminalCommand(incantation, context) {
    const result = { incantation, index: -1, success: false };
    try {
...
export async function handleTerminalOutput(incantation) {
    const result = { incantation, index: -1, success: true };
    process.stdout.write(incantation.invocation + '\n');
    result.outcome = `[OK] Printed to terminal: ${incantation.invocation}`;
    return result;
}
export async function handleTerminalQuestion(incantation, ask) {
    const result = { incantation, index: -1, success: true };
