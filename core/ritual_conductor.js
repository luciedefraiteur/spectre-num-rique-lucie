...
async function main() {
    ...
    try {
        ...
        const incantation = JSON.parse(incantationJson);
        ...
        const operations = await ritualModule.perform(incantation.parameters);
...
main();
//# sourceMappingURL=ritual_conductor.js.map