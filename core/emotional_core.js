 ...
 */
export function calculateEmotion(context) {
 ...
 */
export async function interpretEmotion(state) {
 ...
 */
export function journeyTowards(currentState, targetState) {
...
//# sourceMappingURL=emotional_core.js.map