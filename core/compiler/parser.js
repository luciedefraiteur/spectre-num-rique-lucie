...
import { normalizeLineEndings, detectDialect } from './prelude.js';
import { detectLucidExtensionsInLine, LucidExtensionKind } from './lucid_extensions.js';
/**
 ...
 */
export function parse(source, filePath, verbose = false) {
    ...
    return ts.createSourceFile(filePath, transformedSource, ts.ScriptTarget.Latest, true, // setParentNodes
    getScriptKind(dialect));
}
function getScriptKind(dialect) {
    switch (dialect) {
        case 'javascript':
