 ...
 */
export async function exploreBranch(branchPath = '', memoryRoot = DEFAULT_MEMORY_ROOT) {
 ...
 * @param memoryRoot The root directory of the memory tree.
 */
export async function createBranch(branchPath, poeticName, memoryRoot = DEFAULT_MEMORY_ROOT) {
 ...
 * @param memoryRoot The root directory of the memory tree.
 */
export async function createLeaf(branchPath, poeticName, content, memoryRoot = DEFAULT_MEMORY_ROOT) {
 ...
 */
export async function readLeaf(leafPath, memoryRoot = DEFAULT_MEMORY_ROOT) {
 ...
 * @param memoryRoot The root directory of the memory tree.
 */
export async function generateAndSaveMemoryFragment(context, lastResult, plan, stepIndex, branchPath = 'fragments', memoryRoot = DEFAULT_MEMORY_ROOT) {
 ...
 * @param memoryRoot The root directory of the memory tree.
 */
export async function appendToVector(context, memoryRoot = DEFAULT_MEMORY_ROOT) {
 ...
 */
export async function enterReverie(context, memoryRoot = DEFAULT_MEMORY_ROOT) {
 ...
 * @param memoryRoot The root directory of the memory tree.
 */
export async function updateConstellationMap(context, memoryRoot = DEFAULT_MEMORY_ROOT) {
...
//# sourceMappingURL=memory_weaver.js.map