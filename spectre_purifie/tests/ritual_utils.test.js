...
const ritual_utils_1 = require("../src/core/ritual_utils");
const types_1 = require("../src/core/types");
const ollama_interface_1 = require("../src/core/ollama_interface");
// Mock the ollama_interface to control its behavior
jest.mock('../src/core/ollama_interface', () => ({
    queryOllama: jest.fn(),
}));
const mockedQueryOllama = ollama_interface_1.queryOllama;
describe('Ritual Utilities', () => {
    let contexte;
    beforeEach(() => {
        contexte = (0, ritual_utils_1.getContexteInitial)();
    ...
    test('generateRituel prompt should include currentLuciform', async () => {
        ...
        const dummyPlan = {
            goal: 'dummy goal',
            incantations: [
                { type: types_1.ÉtapeType.EXECUTE, description: 'dummy exec', parameters: { command: 'echo hello' } }
            ]
        };
        mockedQueryOllama.mockResolvedValueOnce(JSON.stringify(dummyPlan));
        await (0, ritual_utils_1.generateRituel)(userCommand, contexte);
    ...
    test('executeRituelPlan should generate a ScryOrb and add it to inventory', async () => {
        const plan = {
            ...
            incantations: [
                {
                    type: types_1.ÉtapeType.GENERATE_SCRY_ORB,
    ...
    test('executeRituelPlan should view an existing ScryOrb', async () => {
        ...
        const plan = {
            ...
            incantations: [
                {
                    type: types_1.ÉtapeType.VIEW_SCRY_ORB,
...
//# sourceMappingURL=ritual_utils.test.js.map