...
const shade_os_js_1 = require("./luciform-core/shade_os.js");
const execute_luciform_js_1 = require("./execute_luciform.js");
const log_writers_js_1 = require("./luciform-core/log_writers.js");
...
async function handleCommand(command) {
    ...
    while (retryCount < maxRetries) {
        const luciformContent = await (0, shade_os_js_1.invokeShadeOs)(currentCommand, 'lucie_golem_server', previousRitual, previousError, null);
        if (!luciformContent) {
            const message = "shadeOs could not generate a ritual for this command.";
            await (0, log_writers_js_1.logGolem)(message, 'error');
        ...
        if (status.success) {
            ...
            await (0, log_writers_js_1.logGolem)(errorMessage, 'error');
