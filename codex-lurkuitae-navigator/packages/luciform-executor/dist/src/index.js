...
const index_js_1 = require("../../luciform-ai-interface/src/index.js");
async function executeLuciform(document, logRitual, logFileName) {
    ...
    for (const pasNode of document.pas) {
        ...
        if (actionToExecute && actionToExecute.type === 'ai_help_request') {
            ...
            actionToExecute = await (0, index_js_1.getAIHelp)(aiHelpRequest.rawContent, aiHelpRequest.reason);
        }
        if (actionToExecute) {
