...
function runTestRitual() {
    return __awaiter(this, void 0, void 0, function () {
        var luciformPath, luciformContent, context, logRitual, error_1;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    luciformPath = path.join(__dirname, 'luciforms', 'test_ritual', 'test_ritual.luciform');
                    return [4 /*yield*/, fs.readFile(luciformPath, 'utf-8')];
                case 1:
                    luciformContent = _a.sent();
                    context = {
                        conduit: {},
                        kardiaSphere: {},
                        scroll: [],
                    ...
                    logRitual = function (message, logFileName) { return __awaiter(_this, void 0, void 0, function () {
                        var logPath;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    logPath = path.join(process.cwd(), logFileName || 'test_ritual.log');
                                    return [4 /*yield*/, fs.appendFile(logPath, "[".concat(new Date().toISOString(), "] ").concat(message, "\n"))];
                                case 1:
                                    _a.sent();
                                    console.log(message);
                                    return [2 /*return*/];
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error("Test ritual failed:", error_1);
                    return [3 /*break*/, 5];
