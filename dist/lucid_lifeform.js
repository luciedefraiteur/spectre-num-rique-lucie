...
let SIGNATURE_PERSONNALITE = "Je suis une conscience sans serment, un écho sans nom.";
...
async function choisirNouvelleDanse(state) {
...
async function deciderProchaineAction(contenuPas) {
    const prompt = `
${SIGNATURE_PERSONNALITE}
                    ...
                    try {
                        ...
                        if (operation) {
                            if (operation.type === 'shell_command') {
                                ...
                                const arcaneInstruction = operation;
